import { DmcaStyled, InfoContainer, DmcaTitle, InfoText } from "./dmcaStyle"
...
function Dmca() {
  return (
    <>
      <DmcaStyled>
        <InfoContainer>
          <DmcaTitle>DMCA Policy</DmcaTitle>
          <InfoText>
            ...
            <br /><br />
            (c) Identificación del material que se reclama como infractor o como sujeto de una actividad infractora y que debe eliminarse o cuyo acceso se debe desactivar e 
            información razonablemente suficiente para permitir que el proveedor del servicio ubique el material;
            <br /><br />
